...
router.put('/user/:id',function(req, res){
  ...
  if (errors){
    ...
    if(req.body.surname) fieldsToChange.room = req.body.surname;
    if(req.body.university) fieldsToChange.speaker = req.body.university;
    if(req.body.year_of_study) fieldsToChange.building = req.body.year_of_study;
